<%-- 
    Document   : products_dumbels2
    Created on : 21 Jul, 2016, 12:10:53 AM
    Author     : Subham
--%>
...
<!-- Sidebar end=============================================== -->
    ...
    <ul class="breadcrumb">
		...
		<li class="active">Products Name: Dumbblles</li>
    </ul>
	<h3> Dumbblles </h3>	
	<hr class="soft"/>
	 ...
	 <div class="tab-pane  active" id="blockView">
		<ul class="thumbnails">
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Dumbbell/1.jpg" alt=""/>
				<div class="caption">
				  <h5>Dumbbell1</h5>
				  <p> 
                   ...
                   <form method="post" action="product_clicked_dumbels.jsp">
                   <button type="submit" id="dumbel1" name="dumbel1" value="dumbel1">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Dumbbell/2.jpg" alt=""/>
				<div class="caption">
				  <h5>Dumbbell2</h5>
				  <p> 
				   ...
				   <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_dumbels.jsp">
                   <button type="submit" id="dumbel2" name="dumbel1" value="dumbel2">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Dumbbell/3.jpg" alt=""/>
				<div class="caption">
				  <h5>Dumbbell3</h5>
				  <p> 
				    ...
				    <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_dumbels.jsp">
                   <button type="submit" id="dumbel3" name="dumbel1" value="dumbel3">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Dumbbell/4.jpg" alt=""/>
				<div class="caption">
				  <h5>Dumbbell4</h5>
				  <p> 
				    ...
				    <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_dumbels.jsp">
                   <button type="submit" id="dumbel4" name="dumbel1" value="dumbel4">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Dumbbell/5.jpg" alt=""/>
				<div class="caption">
				  <h5>Dumbbell5</h5>
				  <p> 
				    ...
				    <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_dumbels.jsp">
                   <button type="submit" id="dumbel5" name="dumbel1" value="dumbel5">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Dumbbell/6.jpg" alt=""/>
				<div class="caption">
				  <h5>Dumbbell6</h5>
				  <p> 
				    ...
				    <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_dumbels.jsp">
                   <button type="submit" id="dumbel6" name="dumbel1" value="dumbel6">View</button>
                   </form>
				</div>
			  </div>
			</li>
