<%-- 
    Document   : products_camera2
    Created on : 21 Jul, 2016, 12:09:34 AM
    Author     : Subham
--%>
...
<!-- Sidebar end=============================================== -->
    ...
    <ul class="breadcrumb">
		...
		<li class="active">Products Name: Camera</li>
    </ul>
	<h3> Cameras </h3>	
	<hr class="soft"/>
	 ...
	 <div class="tab-pane  active" id="blockView">
		<ul class="thumbnails">
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Camera/1.jpg" alt=""/>
				<div class="caption">
				  <h5>Camera1</h5>
				  <p> 
                   ...
                   <form method="post" action="product_clicked_camera.jsp">
                   <button type="submit" id="camera1" name="camera1" value="camera1">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Camera/2.jpg" alt=""/>
				<div class="caption">
				  <h5>Camera2</h5>
				  <p> 
				   ...
				   <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_camera.jsp">
                   <button type="submit" id="camera2" name="camera1" value="camera2">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Camera/3.jpg" alt=""/>
				<div class="caption">
				  <h5>Camera3</h5>
				  <p> 
				    ...
				    <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_camera.jsp">
                   <button type="submit" id="camera3" name="camera1" value="camera3">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Camera/4.jpg" alt="" />
				<div class="caption">
				  <h5>Camera4</h5>
				  <p> 
				    ...
				    <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_camera.jsp">
                   <button type="submit" id="camera4" name="camera1" value="camera4">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Camera/5.jpg" alt=""/>
				<div class="caption">
				  <h5>Camera5</h5>
				  <p> 
				    ...
				    <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_camera.jsp">
                   <button type="submit" id="camera5" name="camera1" value="camera5">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Camera/6.jpg" alt=""/>
				<div class="caption">
				  <h5>Camera6</h5>
				  <p> 
				    ...
				    <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_camera.jsp">
                   <button type="submit" id="camera6" name="camera1" value="camera6">View</button>
                   </form>
				</div>
			  </div>
			</li>
