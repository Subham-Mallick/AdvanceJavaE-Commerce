<%-- 
    Document   : register2
    Created on : 19 Jul, 2016, 10:51:02 PM
    Author     : Subham
--%>
...
<!-- Sidebar end=============================================== -->
	...
	<form class="form-horizontal"  method="get" action="database.jsp">
		...
		<div class="controls">
		  <input type="email" name="textEmail" id="textEmail" placeholder="Email">
		</div>
	  </div>	  
	<div class="control-group">
		...
		<div class="control-group">
			...
			<select id="country" >
				...
				<option value="1">India</option>
                                ...
                                <option value="4">Mountain view</option>
