<%-- 
    ...
    Created on : 20 Jul, 2016, 11:06:20 AM
    Author     : Subham
--%>
...
<!-- Sidebar end=============================================== -->
	...
	<div class="row">	  
			...
			<div class="span6">
				<!--<h3>Fujifilm FinePix S  2950 Digital Camera  </h3>-->
                                <h3><%= session.getAttribute("pname") %></h3>
				<small>- (14MP, 18x Optical Zoom) 3-inch LCD</small>
				<hr class="soft"/>
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					<label class="control-label"><span><%= session.getAttribute("pcontact") %>,<%= session.getAttribute("pcity") %></span></label>
