<%-- 
    Document   : products_laptops2
    Created on : 21 Jul, 2016, 12:11:36 AM
    Author     : Subham
--%>
...
<!-- Sidebar end=============================================== -->
	<div class="span9">
    <ul class="breadcrumb">
		<li><a href="index2.jsp" color="White">Home</a> <span class="divider">/</span></li>
		<li class="active">Products Name: Laptops</li>
    </ul>
	<h3> Laptops </h3>	
	<hr class="soft"/>
	 ...
	 <div class="tab-pane  active" id="blockView">
		<ul class="thumbnails">
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Laptop/1.jpg" alt=""/>
				<div class="caption">
				  <h5>Laptop1</h5>
				  <p> 
                   ...
                   <form method="post" action="product_clicked_laptops.jsp">
                   <button type="submit" id="laptop1" name="laptop1" value="laptop1">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Laptop/2.jpg" alt=""/>
				<div class="caption">
				  <h5>Laptop2</h5>
				  <p> 
				   ...
				   <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_laptops.jsp">
                   <button type="submit" id="laptop2" name="laptop1" value="laptop2">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Laptop/3.jpg" alt=""/>
				<div class="caption">
				  <h5>Laptop3</h5>
				  <p> 
				    ...
				    <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_laptops.jsp">
                   <button type="submit" id="laptop3" name="laptop1" value="laptop3">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Laptop/4.jpg" alt=""/>
				<div class="caption">
				  <h5>Laptop4</h5>
				  <p> 
				    ...
				    <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_laptops.jsp">
                   <button type="submit" id="laptop4" name="laptop1" value="laptop4">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Laptop/5.jpg" alt=""/>
				<div class="caption">
				  <h5>Laptop5</h5>
				  <p> 
				    ...
				    <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_laptops.jsp">
                   <button type="submit" id="laptop5" name="laptop1" value="laptop5">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Laptop/6.jpg" alt=""/>
				<div class="caption">
				  <h5>Laptop6</h5>
				  <p> 
				    ...
				    <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_laptops.jsp">
                   <button type="submit" id="laptop6" name="laptop1" value="laptop6">View</button>
                   </form>
				</div>
			  </div>
			</li>
