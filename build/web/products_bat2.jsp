<%-- 
    Document   : products_bat
    Created on : 21 Jul, 2016, 12:09:56 AM
    Author     : Subham
--%>
...
<!-- Sidebar end=============================================== -->
    ...
    <ul class="breadcrumb">
		...
		<li class="active">Products Name: Bats</li>
    </ul>
	<h3> Bats </h3>	
	<hr class="soft"/>
	 ...
	 <div class="tab-pane  active" id="blockView">
		<ul class="thumbnails">
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Bats/1.jpg" alt=""/>
				<div class="caption">
				  <h5>Bat1</h5>
				  <p> 
                   ...
                   <form method="get" action="product_clicked.jsp">
                   <button type="submit" id="bats1" name="bats1" value="bats1">View</button>
                   </form> 
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Bats/2.jpg" alt=""/>
				<div class="caption">
				  <h5>Bat2</h5>
				  <p> 
				   ...
				   <h4 style="text-align:center"></h4>
                   <form method="get" action="product_clicked.jsp">
                   <button type="submit" id="bats1" name="bats1" value="bats2">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Bats/3.jpg" alt=""/>
				<div class="caption">
				  <h5>Bat3</h5>
				  <p> 
				    ...
				    <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked.jsp">
                   <button type="submit" id="bats3" name="bats1" value="bats3">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Bats/4.jpeg" alt=""/>
				<div class="caption">
				  <h5>Bat4</h5>
				  <p> 
				    ...
				    <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked.jsp">
                   <button type="submit" id="bats4" name="bats1" value="bats4">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Bats/5.jpg" alt=""/>
				<div class="caption">
				  <h5>Bat5</h5>
				  <p> 
				    ...
				    <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked.jsp">
                   <button type="submit" id="bats5" name="bats1" value="bats5">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Bats/6.jpg" alt=""/>
				<div class="caption">
				  <h5>Bat6</h5>
				  <p> 
				    ...
				    <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked.jsp">
                   <button type="submit" id="bats6" name="bats1" value="bats6">View</button>
                   </form>
				</div>
			  </div>
			</li>
