<%-- 
    Document   : products_honda2
    Created on : 21 Jul, 2016, 12:11:15 AM
    Author     : Subham
--%>
...
<!-- Sidebar end=============================================== -->
    ...
    <ul class="breadcrumb">
		...
		<li class="active">Products Name: Honda</li>
    </ul>
	<h3> Honda Cars </h3>	
	<hr class="soft"/>
	 ...
	 <div class="tab-pane  active" id="blockView">
		<ul class="thumbnails">
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Honda/1.jpg" alt=""/>
				<div class="caption">
				  <h5>Honda1</h5>
				  <p> 
                   ...
                   <form method="post" action="product_clicked_honda.jsp">
                   <button type="submit" id="honda1" name="honda1" value="honda1">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Honda/2.jpeg" alt=""/>
				<div class="caption">
				  <h5>Honda2</h5>
				  <p> 
                                  ...
                                  <h4 style="text-align:center" > </h4> 
                   <form method="post" action="product_clicked_honda.jsp">
                   <button type="submit" id="honda2" name="honda1" value="honda2">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Honda/3.JPG" alt=""/>
				<div class="caption">
				  <h5>Honda3</h5>
				  <p> 
                                  ...
                                  <h4 style="text-align:center"> </h4>
                    <form method="post" action="product_clicked_honda.jsp">
                   <button type="submit" id="honda3" name="honda1" value="honda3">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Honda/4.JPG" alt=""/>
				<div class="caption">
				  <h5>Honda4</h5>
				  <p> 
                                  ...
                                  <h4 style="text-align:center"> </h4>
                   <form method="post" action="product_clicked_honda.jsp">
                   <button type="submit" id="honda4" name="honda1" value="honda4">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Honda/5.jpg" alt=""/>
				<div class="caption">
				  <h5>Honda5</h5>
				  <p> 
                                  ...
                                  <h4 style="text-align:center"> </h4>
                    <form method="post" action="product_clicked_honda.jsp">
                   <button type="submit" id="honda5" name="honda1" value="honda5">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Honda/6.jpg" alt=""/>
				<div class="caption">
				  <h5>Honda6</h5>
				  <p> 
                                  ...
                                  <h4 style="text-align:center"> </h4>
                    <form method="post" action="product_clicked_honda.jsp">
                   <button type="submit" id="honda6" name="honda1" value="honda6">View</button>
                   </form>
				</div>
			  </div>
			</li>
