<%-- 
    Document   : products_sofa
    Created on : 21 Jul, 2016, 12:12:08 AM
    Author     : Subham
--%>
...
<!-- Sidebar end=============================================== -->
    ...
    <ul class="breadcrumb">
		...
		<li class="active">Products Name: Sofa</li>
    </ul>
	<h3> Sofa </h3>	
	<hr class="soft"/>
	 ...
	 <div class="tab-pane  active" id="blockView">
		<ul class="thumbnails">
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Sofa/1.jpg" alt=""/>
				<div class="caption">
				  <h5>Sofa1</h5>
				  <p> 
                   ...
                   <form method="post" action="product_clicked_sofa.jsp">
                   <button type="submit" id="sofa1" name="sofa1" value="sofa1">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Sofa/2.jpg" alt=""/>
				<div class="caption">
				  <h5>Sofa2</h5>
				  <p> 
				   ...
				   <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_sofa.jsp">
                   <button type="submit" id="sofa2" name="sofa1" value="sofa2">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Sofa/3.jpg" alt=""/>
				<div class="caption">
				  <h5>Sofa3</h5>
				  <p> 
				    ...
				    <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_sofa.jsp">
                   <button type="submit" id="sofa3" name="sofa1" value="sofa3">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Sofa/4.jpg" alt=""/>
				<div class="caption">
				  <h5>Sofa4</h5>
				  <p> 
				    ...
				    <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_sofa.jsp">
                   <button type="submit" id="sofa4" name="sofa1" value="sofa4">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Sofa/5.jpg" alt=""/>
				<div class="caption">
				  <h5>Sofa5</h5>
				  <p> 
				    ...
				    <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_sofa.jsp">
                   <button type="submit" id="sofa5" name="sofa1" value="sofa5">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Sofa/6.jpeg" alt=""/>
				<div class="caption">
				  <h5>Sofa6</h5>
				  <p> 
				    ...
				    <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_sofa.jsp">
                   <button type="submit" id="sofa6" name="sofa1" value="sofa6">View</button>
                   </form>
				</div>
			  </div>
			</li>
