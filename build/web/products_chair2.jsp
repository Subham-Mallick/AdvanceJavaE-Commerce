<%-- 
    Document   : products_chair2
    Created on : 21 Jul, 2016, 12:10:35 AM
    Author     : Subham
--%>
...
<!-- Sidebar end=============================================== -->
    ...
    <ul class="breadcrumb">
		...
		<li class="active">Products Name: Chairs</li>
    </ul>
	<h3> Chairs </h3>	
	<hr class="soft"/>
	 ...
	 <div class="tab-pane  active" id="blockView">
		<ul class="thumbnails">
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Chair/1.jpg" alt=""/>
				<div class="caption">
				  <h5>Chair1</h5>
				  <p> 
                   ...
                   <form method="post" action="product_clicked_chair.jsp">
                   <button type="submit" id="chair1" name="chair1" value="chair1">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Chair/2.jpg" alt=""/>
				<div class="caption">
				  <h5>Chair2</h5>
				  <p> 
				   ...
				   <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_chair.jsp">
                   <button type="submit" id="chair2" name="chair1" value="chair2">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Chair/3.jpg" alt=""/>
				<div class="caption">
				  <h5>Chair3</h5>
				  <p> 
				    ...
				    <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_chair.jsp">
                   <button type="submit" id="chair3" name="chair1" value="chair3">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Chair/4.jpg" alt=""/>
				<div class="caption">
				  <h5>Chair4</h5>
				  <p> 
				    ...
				    <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_chair.jsp">
                   <button type="submit" id="chair4" name="chair1" value="chair4">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Chair/5.jpg" alt=""/>
				<div class="caption">
				  <h5>Chair5</h5>
				  <p> 
				    ...
				    <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_chair.jsp">
                   <button type="submit" id="chair5" name="chair1" value="chair5">View</button>
                   </form>
				</div>
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="pimages/Chair/6.jpg" alt=""/>
				<div class="caption">
				  <h5>Chair6</h5>
				  <p> 
				    ...
				    <h4 style="text-align:center"></h4>
                   <form method="post" action="product_clicked_chair.jsp">
                   <button type="submit" id="chair6" name="chair1" value="chair6">View</button>
                   </form>
				</div>
			  </div>
			</li>
