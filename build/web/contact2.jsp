<%-- 
    Document   : contact2
    Created on : 19 Jul, 2016, 10:46:26 PM
    Author     : Subham
--%>
...
<a id="smallScreen" data-target="#topMenu" data-toggle="collapse" class="btn btn-navbar">
  ...
  <div class="navbar-inner">
    ...
    <ul id="topMenu" class="nav pull-right">
	 ...
	 <li class=""><a href="contact.html">Details</a></li>
...
<div class="container">
	...
	<div class="row">
		...
		<h4>Deatils</h4>
                <p>
                    This is a classified website designed on JSP and backended with Oracle data base.
                </p>
