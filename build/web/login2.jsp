<%-- 
    Document   : login
    Created on : 19 Jul, 2016, 10:16:11 AM
    Author     : Subham
--%>
	...
	<div class="row">
		...
		<div class="span4">
			...
			<h5>ALREADY REGISTERED ?</h5>
                        <form method="post" action="database_login.jsp">
			  <div class="control-group">
				<label class="control-label" for="inputEmail1">Email</label>
				<div class="controls">
				  <input class="span3"  type="text" name="userLoginEmail" id="userLoginEmail" placeholder="Email">
				</div>
			  </div>
			  <div class="control-group">
				<label class="control-label" for="inputPassword1">Password</label>
				<div class="controls">
				  <input type="password" class="span3"  name="userLoginPassword" id="userLoginPassword" placeholder="Password">
				</div>
			  </div>
			  <div class="control-group">
				<div class="controls">
